...
export class GeneratedParser extends Parser {
    ...
    // @memoize
    lambda_slash_with_default() // #!/usr/bin/env python3.8
    // # @generated by pegen from /Users/scork/Desktop/PythonProjects/cpython/Grammar/python.gram
    
    import * as ast from "./ast";
    import * as astnodes from "../asdl/astnodes";
    
    import {memoize, memoizeLeftRec, Parser} from "./parser";
    ...
    export class GeneratedParser extends Parser {
        ...
        fstring() {
            ...
            let mark, star_expressions;
                    mark = this.mark();
            if (
                (star_expressions = this.star_expressions())
            ) {
                return star_expressions;
            }
            this.reset(mark);
        ...
        statement_newline() {
            ...
            this.reset(mark);
            if (
                (simple_stmts = this.simple_stmts())
            ) {
                return simple_stmts;
            }
            this.reset(mark);
        ...
        simple_stmt() {
            ...
            this.reset(mark);
            if (
                (e = this.star_expressions())
            ) {
                return new astnodes.Expr ( e , ...EXTRA );
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'return')
                &&
                (return_stmt = this.return_stmt())
            ) {
                return return_stmt;
            }
            this.reset(mark);
            if (
                ...
                &&
                (import_stmt = this.import_stmt())
            ) {
                return import_stmt;
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'raise')
                &&
                (raise_stmt = this.raise_stmt())
            ) {
                return raise_stmt;
            }
            this.reset(mark);
            if (
                (literal = this.expect('pass'))
            ) {
                return new astnodes.Pass ( ...EXTRA );
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'del')
                &&
                (del_stmt = this.del_stmt())
            ) {
                return del_stmt;
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'yield')
                &&
                (yield_stmt = this.yield_stmt())
            ) {
                return yield_stmt;
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'assert')
                &&
                (assert_stmt = this.assert_stmt())
            ) {
                return assert_stmt;
            }
            this.reset(mark);
            if (
                (literal = this.expect('break'))
            ) {
                return new astnodes.Break ( ...EXTRA );
            }
            this.reset(mark);
            if (
                (literal = this.expect('continue'))
            ) {
                return new astnodes.Continue ( ...EXTRA );
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'global')
                &&
                (global_stmt = this.global_stmt())
            ) {
                return global_stmt;
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'nonlocal')
                &&
                (nonlocal_stmt = this.nonlocal_stmt())
            ) {
                return nonlocal_stmt;
            }
            this.reset(mark);
        ...
        compound_stmt() {
            ...
            if (
                ...
                &&
                (function_def = this.function_def())
            ) {
                return function_def;
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'if')
                &&
                (if_stmt = this.if_stmt())
            ) {
                return if_stmt;
            }
            this.reset(mark);
            ...
            if (
                ...
                &&
                (for_stmt = this.for_stmt())
            ) {
                return for_stmt;
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'try')
                &&
                (try_stmt = this.try_stmt())
            ) {
                return try_stmt;
            }
            this.reset(mark);
            if (
                this.positive_lookahead(this.expect, 'while')
                &&
                (while_stmt = this.while_stmt())
            ) {
                return while_stmt;
            }
            this.reset(mark);
        ...
        assignment() {
            ...
            cut = false;
            if (
                (invalid_assignment = this.invalid_assignment())
            ) {
                return invalid_assignment;
            }
            this.reset(mark);
        ...
        del_stmt() {
            ...
            this.reset(mark);
            if (
                (invalid_del_stmt = this.invalid_del_stmt())
            ) {
                return invalid_del_stmt;
            }
            this.reset(mark);
        ...
        import_name() {
            ...
            let a, literal, mark;
                    mark = this.mark();
            if (
                (literal = this.expect('import'))
                &&
                (a = this.dotted_as_names())
            ) {
                return new astnodes.Import ( a , ...EXTRA );
            }
            this.reset(mark);
        ...
        import_from_targets() {
            ...
            this.reset(mark);
            if (
                (invalid_import_from_targets = this.invalid_import_from_targets())
            ) {
                return invalid_import_from_targets;
            }
            this.reset(mark);
        ...
        for_stmt() {
            ...
            cut = false;
            if (
                (invalid_for_target = this.invalid_for_target())
            ) {
                return invalid_for_target;
            }
            this.reset(mark);
        ...
        with_item() {
            ...
            this.reset(mark);
            if (
                (invalid_with_item = this.invalid_with_item())
            ) {
                return invalid_with_item;
            }
            this.reset(mark);
        ...
        function_def() {
            ...
            if (
                (d = this.decorators())
                &&
                (f = this.function_def_raw())
            ) {
                return pegen.function_def_decorators ( d , f );
            }
            this.reset(mark);
            if (
                (function_def_raw = this.function_def_raw())
            ) {
                return function_def_raw;
            }
            this.reset(mark);
        ...
        func_type_comment() {
            ...
            this.reset(mark);
            if (
                (invalid_double_type_comments = this.invalid_double_type_comments())
            ) {
                return invalid_double_type_comments;
            }
            this.reset(mark);
        ...
        star_etc() {
            ...
            this.reset(mark);
            if (
                (invalid_star_etc = this.invalid_star_etc())
            ) {
                return invalid_star_etc;
            }
            this.reset(mark);
        ...
        class_def() {
            ...
            if (
                (a = this.decorators())
                &&
                (b = this.class_def_raw())
            ) {
                return pegen.class_def_decorators ( a , b );
            }
            this.reset(mark);
            if (
                (class_def_raw = this.class_def_raw())
            ) {
                return class_def_raw;
            }
            this.reset(mark);
        ...
        block() {
            ...
            this.reset(mark);
            if (
                (invalid_block = this.invalid_block())
            ) {
                return invalid_block;
            }
            this.reset(mark);
        ...
        star_expressions() {
            ...
            this.reset(mark);
            if (
                (star_expression = this.star_expression())
            ) {
                return star_expression;
            }
            this.reset(mark);
        ...
        star_named_expression() {
            ...
            this.reset(mark);
            if (
                (named_expression = this.named_expression())
            ) {
                return named_expression;
            }
            this.reset(mark);
        ...
        named_expression() {
            ...
            this.reset(mark);
            if (
                (invalid_named_expression = this.invalid_named_expression())
            ) {
                return invalid_named_expression;
            }
            this.reset(mark);
        ...
        lambda_params() {
            ...
            let invalid_lambda_parameters, lambda_parameters, mark;
                    mark = this.mark();
            if (
                (invalid_lambda_parameters = this.invalid_lambda_parameters())
            ) {
                return invalid_lambda_parameters;
            }
            this.reset(mark);
            if (
                (lambda_parameters = this.lambda_parameters())
            ) {
                return lambda_parameters;
            }
            this.reset(mark);
        ...
        lambda_parameters() {
            ...
            if (
                ...
                (c = this._loop0_75())
                &&
                (d = this.lambda_star_etc())
            ) {
                return pegen.make_arguments ( a , null , b , c , d );
            }
            this.reset(mark);
            if (
                (a = this.lambda_slash_with_default())
                &&
                (b = this._loop0_76())
                &&
                (c = this.lambda_star_etc())
            ) {
                return pegen.make_arguments ( null , a , null , b , c );
            }
            this.reset(mark);
            ...
            if (
                (a = this._loop1_79())
                &&
                (b = this.lambda_star_etc())
            ) {
                return pegen.make_arguments ( null , null , null , a , b );
            }
            this.reset(mark);
            if (
                (a = this.lambda_star_etc())
            ) {
                return pegen.make_arguments ( null , null , null , null , a );
            }
            this.reset(mark);
        ...
        lambda_star_etc() {
            ...
            this.reset(mark);
            if (
                (invalid_lambda_star_etc = this.invalid_lambda_star_etc())
            ) {
        ...
        compare_op_bitwise_or_pair() {
            ...
            let eq_bitwise_or, gt_bitwise_or, gte_bitwise_or, in_bitwise_or, is_bitwise_or, isnot_bitwise_or, lt_bitwise_or, lte_bitwise_or, mark, noteq_bitwise_or, notin_bitwise_or;
                    mark = this.mark();
            if (
                (eq_bitwise_or = this.eq_bitwise_or())
            ) {
                return eq_bitwise_or;
            }
            this.reset(mark);
            if (
                (noteq_bitwise_or = this.noteq_bitwise_or())
            ) {
                return noteq_bitwise_or;
            }
            this.reset(mark);
            if (
                (lte_bitwise_or = this.lte_bitwise_or())
            ) {
                return lte_bitwise_or;
            }
            this.reset(mark);
            if (
                (lt_bitwise_or = this.lt_bitwise_or())
            ) {
                return lt_bitwise_or;
            }
            this.reset(mark);
            if (
                (gte_bitwise_or = this.gte_bitwise_or())
            ) {
                return gte_bitwise_or;
            }
            this.reset(mark);
            if (
                (gt_bitwise_or = this.gt_bitwise_or())
            ) {
                return gt_bitwise_or;
            }
            this.reset(mark);
            if (
                (notin_bitwise_or = this.notin_bitwise_or())
            ) {
                return notin_bitwise_or;
            }
            this.reset(mark);
            if (
                (in_bitwise_or = this.in_bitwise_or())
            ) {
                return in_bitwise_or;
            }
            this.reset(mark);
            if (
                (isnot_bitwise_or = this.isnot_bitwise_or())
            ) {
                return isnot_bitwise_or;
            }
            this.reset(mark);
            if (
                (is_bitwise_or = this.is_bitwise_or())
            ) {
        ...
        isnot_bitwise_or() {
            ...
            let a, literal, literal_1, mark;
                    mark = this.mark();
            if (
                (literal = this.expect('is'))
                &&
                (literal_1 = this.expect('not'))
                &&
                (a = this.bitwise_or())
            ) {
        ...
        power() {
            ...
            this.reset(mark);
            if (
                (await_primary = this.await_primary())
            ) {
        ...
        primary() {
            ...
            let a, atom, b, invalid_primary, literal, literal_1, mark;
                    mark = this.mark();
            if (
                (invalid_primary = this.invalid_primary())
            ) {
        ...
        listcomp() {
            ...
            cut = false;
            if (
                (invalid_comprehension = this.invalid_comprehension())
            ) {
        ...
        group() {
            ...
            this.reset(mark);
            if (
                (invalid_group = this.invalid_group())
            ) {
        ...
        dictcomp() {
            ...
            this.reset(mark);
            if (
                (invalid_dict_comprehension = this.invalid_dict_comprehension())
            ) {
        ...
        yield_expr() {
            ...
            let a, literal, literal_1, mark;
                    mark = this.mark();
            if (
                (literal = this.expect('yield'))
                &&
                (literal_1 = this.expect('from'))
                &&
                (a = this.expression())
            ) {
        ...
        arguments() {
            ...
            this.reset(mark);
            if (
                (invalid_arguments = this.invalid_arguments())
            ) {
        ...
        kwargs() {
            ...
            this.reset(mark);
            if (
                (_gather_112 = this._gather_112())
            ) {
                return _gather_112;
            }
            this.reset(mark);
            if (
                (_gather_114 = this._gather_114())
            ) {
                return _gather_114;
            }
            this.reset(mark);
        ...
        kwarg_or_starred() {
            ...
            this.reset(mark);
            if (
                (invalid_kwarg = this.invalid_kwarg())
            ) {
        ...
        single_target() {
            ...
            let a, literal, literal_1, mark, single_subscript_attribute_target;
                    mark = this.mark();
            if (
                (single_subscript_attribute_target = this.single_subscript_attribute_target())
            ) {
        ...
        invalid_assignment() {
            ...
            if (
                (a = this.star_expressions())
                &&
                (augassign = this.augassign())
                &&
                (_tmp_128 = this._tmp_128())
            ) {
        ...
        invalid_block() {
            ...
            if (
                (newline = this.expect('NEWLINE'))
                &&
                this.negative_lookahead(this.expect, 'INDENT')
            ) {
        ...
        invalid_parameters() {
            ...
            let _loop0_130, _tmp_131, mark, param_no_default;
                    mark = this.mark();
            if (
                (_loop0_130 = this._loop0_130())
                &&
                (_tmp_131 = this._tmp_131())
                &&
        ...
        invalid_lambda_parameters() {
            ...
            let _loop0_132, _tmp_133, lambda_param_no_default, mark;
                    mark = this.mark();
            if (
                (_loop0_132 = this._loop0_132())
                &&
                (_tmp_133 = this._tmp_133())
                &&
        ...
        _loop1_48() {
            ...
            children = [];
            while (
                (except_block = this.except_block())
            ) {
        ...
        _loop0_55() {
            ...
            children = [];
            while (
                (param_with_default = this.param_with_default())
            ) {
        ...
        _loop0_66() {
            ...
            children = [];
            while (
                (param_maybe_default = this.param_maybe_default())
            ) {
        ...
        _loop0_72() {
            ...
            while (
                (literal = this.expect(','))
                &&
                (elem = this.star_named_expression())
            ) {
                children.push(elem);
                mark = this.mark();
            }
        ...
        _loop0_75() {
            ...
            children = [];
            while (
                (lambda_param_with_default = this.lambda_param_with_default())
            ) {
        ...
        _loop0_86() {
            ...
            children = [];
            while (
                (lambda_param_maybe_default = this.lambda_param_maybe_default())
            ) {
        ...
        _loop1_90() {
            ...
            children = [];
            while (
                (compare_op_bitwise_or_pair = this.compare_op_bitwise_or_pair())
            ) {
        ...
        _loop0_101() {
            ...
            while (
                (literal = this.expect(','))
                &&
                (elem = this.double_starred_kvpair())
            ) {
                children.push(elem);
                mark = this.mark();
            }
        ...
        _loop1_102() {
            ...
            children = [];
            while (
                (for_if_clause = this.for_if_clause())
            ) {
        ...
        _loop0_111() {
            ...
            while (
                (literal = this.expect(','))
                &&
                (elem = this.kwarg_or_double_starred())
            ) {
                children.push(elem);
                mark = this.mark();
            }
        ...
        _loop0_125() {
            ...
            children = [];
            while (
                (star_named_expressions = this.star_named_expressions())
            ) {
        ...
        _tmp_131() {
            ...
            let _loop1_150, mark, slash_with_default;
                    mark = this.mark();
            if (
                (slash_with_default = this.slash_with_default())
            ) {
                return slash_with_default;
            }
            this.reset(mark);
            if (
                (_loop1_150 = this._loop1_150())
            ) {
                return _loop1_150;
            }
            this.reset(mark);
        ...
        _tmp_133() {
            ...
            let _loop1_151, lambda_slash_with_default, mark;
                    mark = this.mark();
            if (
                (lambda_slash_with_default = this.lambda_slash_with_default())
            ) {
                return lambda_slash_with_default;
            }
            this.reset(mark);
            if (
                (_loop1_151 = this._loop1_151())
            ) {
                return _loop1_151;
            }
            this.reset(mark);
        ...
        _tmp_146() {
            ...
            let mark, named_expression, starred_expression;
                    mark = this.mark();
            if (
                (starred_expression = this.starred_expression())
            ) {
        ...
        _tmp_148() {
            ...
            let literal, mark, star_targets;
                    mark = this.mark();
            if (
                (star_targets = this.star_targets())
                &&
                (literal = this.expect('='))
            ) {
