var Sk = (function (exports) {
    ...
    /** @constructor */
    const Return = function Return(/* {expr_ty} */ value, /* {int} */ lineno, /* {int} */ col_offset) {
        this.value = value;
        this.lineno = lineno;
        this.col_offset = col_offset;
    };
    ...
    /** @constructor */
    const Delete = function Delete(/* {asdl_seq *} */ targets /* {int} */, lineno, /* {int} */ col_offset) {
    ...
    /** @constructor */
    const With = function With(/* {asdl_seq *} */ items /* {asdl_seq *} */, body, /* {int} */ lineno /* {int} */, col_offset) {
        this.items = items;
        this.body = body;
        this.lineno = lineno;
        this.col_offset = col_offset;
    ...
    /** @constructor */
    const Raise = function Raise(/* {expr_ty} */ exc, /* {expr_ty} */ cause, /* {expr_ty} */ inst /* {expr_ty} */, tback, /* {int} */ lineno /* {int} */, col_offset) {
        this.exc = exc;
        this.cause = cause;
        this.inst = inst;
        this.tback = tback;
    ...
    /** @constructor */
    const Assert = function Assert(/* {expr_ty} */ test, /* {expr_ty} */ msg, /* {int} */ lineno /* {int} */, col_offset) {
        this.test = test;
        this.msg = msg;
        this.lineno = lineno;
        this.col_offset = col_offset;
    ...
    /** @constructor */
    const Import = function Import(/* {asdl_seq *} */ names /* {int} */, lineno, /* {int} */ col_offset) {
        this.names = names;
        this.lineno = lineno;
        this.col_offset = col_offset;
    };
    ...
    /** @constructor */
    const Global = function Global(/* {asdl_seq *} */ names /* {int} */, lineno, /* {int} */ col_offset) {
        this.names = names;
        this.lineno = lineno;
        this.col_offset = col_offset;
    };
    ...
    /** @constructor */
    const Nonlocal = function Nonlocal(/* {asdl_seq *} */ names /* {int} */, lineno, /* {int} */ col_offset) {
        this.names = names;
        this.lineno = lineno;
        this.col_offset = col_offset;
    };
    ...
    /** @constructor */
    const Expr = function Expr(/* {expr_ty} */ value, /* {int} */ lineno, /*
                                          {int} */ col_offset) {
        this.value = value;
        this.lineno = lineno;
        this.col_offset = col_offset;
    ...
    /** @constructor */
    const Break = function Break(/* {int} */ lineno, /* {int} */ col_offset) {
        this.lineno = lineno;
        this.col_offset = col_offset;
    };

    /** @constructor */
    const Continue = function Continue(/* {int} */ lineno /* {int} */, col_offset) {
        this.lineno = lineno;
        this.col_offset = col_offset;
    };
    ...
    /** @constructor */
    const BinOp = function BinOp(/* {expr_ty} */ left /* {operator_ty} */, op, /* {expr_ty} */ right /* {int} */, lineno, /* {int} */ col_offset) {
        this.left = left;
        this.op = op;
        this.right = right;
        this.lineno = lineno;
    ...
    /** @constructor */
    const IfExp = function IfExp(/* {expr_ty} */ test, /* {expr_ty} */ body, /* {expr_ty} */ orelse /* {int} */, lineno, /* {int} */ col_offset) {
        this.test = test;
        this.body = body;
        this.orelse = orelse;
        this.lineno = lineno;
    ...
    /** @constructor */
    const Dict = function Dict(/* {asdl_seq *} */ keys /* {asdl_seq *} */, values, /* {int} */ lineno /* {int} */, col_offset) {
        this.keys = keys;
        this.values = values;
        this.lineno = lineno;
        this.col_offset = col_offset;
    ...
    /** @constructor */
    const Set$1 = function Set(/* {asdl_seq *} */ elts, /* {int} */ lineno, /*
                                        {int} */ col_offset) {
        this.elts = elts;
        this.lineno = lineno;
        this.col_offset = col_offset;
    ...
    /** @constructor */
    const DictComp = function DictComp(/* {expr_ty} */ key /* {expr_ty} */, value /* {asdl_seq *} */, generators, /* {int} */ lineno, /* {int} */ col_offset) {
        this.key = key;
        this.value = value;
        this.generators = generators;
        this.lineno = lineno;
    ...
    /** @constructor */
    const Await = function Await(/* {expr_ty} */ value, /* {int} */ lineno, /* {int} */ col_offset) {
        this.value = value;
        this.lineno = lineno;
        this.col_offset = col_offset;
    };
    ...
    /** @constructor */
    const Yield = function Yield(/* {expr_ty} */ value, /* {int} */ lineno, /* {int} */ col_offset) {
        this.value = value;
        this.lineno = lineno;
        this.col_offset = col_offset;
    };
    ...
    /** @constructor */
    const YieldFrom = function YieldFrom(/* {expr_ty} */ value /* {int} */, lineno, /* {int} */ col_offset) {
        this.value = value;
        this.lineno = lineno;
        this.col_offset = col_offset;
    };
    ...
    /** @constructor */
    const Call = function Call(/* {expr_ty} */ func, /* {asdl_seq *} */ args, /* {asdl_seq *} */ keywords /* {int} */, lineno, /* {int} */ col_offset) {
        this.func = func;
        this.args = args;
        this.keywords = keywords;
        this.lineno = lineno;
    ...
    /** @constructor */
    const Constant = function Constant(/* {constant} */ value /* {int} */, lineno, /* {int} */ col_offset) {
        this.value = value;
        this.lineno = lineno;
        this.col_offset = col_offset;
    };
    ...
    /** @constructor */
    const Slice = function Slice(/* {expr_ty} */ lower /* {expr_ty} */, upper, /* {expr_ty} */ step) {
        this.lower = lower;
        this.upper = upper;
        this.step = step;
    };
    ...
    /** @constructor */
    const arg = function arg(/* {identifier} */ arg /* {expr_ty} */, annotation) {
        this.arg = arg;
        this.annotation = annotation;
    };

    /** @constructor */
    const keyword = function keyword(/* {identifier} */ arg /* {expr_ty} */, value) {
        this.arg = arg;
        this.value = value;
    };

    /** @constructor */
    const alias = function alias(/* {identifier} */ name /* {identifier} */, asname) {
        this.name = name;
        this.asname = asname;
    };

    /** @constructor */
    const withitem = function withitem(/* {expr_ty} */ context_expr, /*
    ...
    */
    ...
    function memoize(cls, method_name) {
    ...
    function memoizeLeftRec(cls, method_name) {
        // """Memoize a left-recursive symbol method."""
        const descriptor = Object.getOwnPropertyDescriptor(cls.prototype, method_name);
        const method = descriptor.value;
        function memoize_left_rec_wrapper(...args) {
            let mark = this.mark();
